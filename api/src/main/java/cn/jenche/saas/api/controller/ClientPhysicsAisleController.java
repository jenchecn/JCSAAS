...
public class ClientPhysicsAisleController extends BaseController {
    ...
    @GetMapping(value = "/client/aisle/physics/{clientId}")
    ...
    public ResponseResultDTO save(@RequestBody @Valid ClientPhysicsAisleDTO clientPhysicsAisleDTO, BindingResult bindingResult)
    ...
    public ResponseResultDTO update(@RequestBody @Valid ClientPhysicsAisleDTO clientPhysicsAisleDTO, BindingResult bindingResult)
            throws SystemException {
