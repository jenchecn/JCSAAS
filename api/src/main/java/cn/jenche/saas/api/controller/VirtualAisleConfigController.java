...
public class VirtualAisleConfigController extends BaseController {
    ...
    @GetMapping(value = "/virtualAisleConfig/{id}")
    ...
    public ResponseResultDTO save(@RequestBody @Valid VirtualAisleConfigDTO virtualAisleConfigDTO, BindingResult bindingResult)
    ...
    public ResponseResultDTO update(@RequestBody @Valid VirtualAisleConfigDTO virtualAisleConfigDTO, BindingResult bindingResult)
            throws SystemException {
