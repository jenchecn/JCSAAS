...
public class GoodsCategoryController extends BaseController {
    ...
    @GetMapping(value = "/goodscategory/{id}")
    ...
    public ResponseResultDTO save(@RequestBody @Valid GoodsCategoryDTO goodsCategoryDTO, BindingResult bindingResult)
    ...
    public ResponseResultDTO update(@RequestBody @Valid GoodsCategoryDTO goodsCategoryDTO, BindingResult bindingResult)
            throws SystemException {
